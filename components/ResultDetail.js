...
export default function ResultDetail({ result }) {
  ...
  if (!result) {
    // result nesnesi tanımsızsa veya eksikse, uygun bir hata mesajını veya alternatif bir içeriği döndürün
    console.log("result undefined geldi");
    return <Text>Veri yok veya eksik</Text>;
  }
